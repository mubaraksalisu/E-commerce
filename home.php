          ...
          <div id="slider-carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="item active">
                <div class="col-sm-6">
                  <h1><span>Hafsat</span>-Store</h1>
                  <h2>50% Discount On Shipping</h2>
                  <p>You get 50% off on shipping to any part of the world. </p>
              ...
              <div class="item">
                <div class="col-sm-6">
                  <h1><span>Hafsat</span>-Store</h1>
                  <h2>100% Secure</h2>
                  <p> Pay with confident as our web-store is completely secure. And your profile is not shared with anyone</p>
              ...
              <div class="item">
                <div class="col-sm-6">
                  <h1><span>Hafsat</span>-Store</h1>
                  <h2>Free Item After Spending NGN10,000</h2>
                  <p>Spend 10,000 to get one item for free. </p>
      ...
      <div class="row">
        ...
        <div class="col-sm-9 padding-right">
          <div class="features_items"><!--features_items-->
            ...
            WHERE pr.`PROID`=p.`PROID` AND  p.`CATEGID` = c.`CATEGID`  AND PROQTY>0 LIMIT 4";
            $mydb->setQuery($query);
              ...
              <div class="product-image-wrapper">
                <div class="single-products">
                    <div class="productinfo text-center">
                      ...
                      <h2>NGN <?php  echo $result->PRODISPRICE; ?></h2>
          ...
          <div class="recommended_items"><!--recommended_items-->
            ...
            <input type="hidden" name="PROID" value="<?php  echo $result->PROID; ?>">
                ...
                <div class="item">
                  <?php
                    $query = "SELECT * FROM `tblpromopro` pr , `tblproduct` p , `tblcategory` c
                    WHERE pr.`PROID`=p.`PROID` AND  p.`CATEGID` = c.`CATEGID`  AND PROQTY>0 limit 4,4";
                    $mydb->setQuery($query);
                    $cur = $mydb->loadResultList();
