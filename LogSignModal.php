                      ...
                      <!-- <h4>Login Tab</h4>  -->
                       <div class="panel panel-pup">
                        ...
                        <div class="panel-footer">
                             <p align="left">&copy; Hafsat Store</p>
                        </div>
                    </div>
                  </div>
                  <!-- end login panel -->
                                     ...
                                     <div class="panel-body">
                                      ...
                                      <div class="form-group">
                                        <div class="col-md-10">
                                          ...
                                          <div class="col-md-8">
                                             <input class="form-control input-sm" id="FNAME" name="FNAME" onkeypress="return /[a-z]/i.test(event.key)" placeholder=
                                      ...
                                      <div class="form-group">
                                        <div class="col-md-10">
                                          ...
                                          <div class="col-md-8">
                                             <input class="form-control input-sm" id="LNAME" name="LNAME" onkeypress="return /[a-z]/i.test(event.key)" placeholder=
                                       ...
                                       <div class="form-group">
                                        <div class="col-md-10">
                                          ...
                                          <div class="col-md-8">
                                          <select class="form-control" name="state" id="state" onchange="stateOpenLga()">
                                          ...
                                          <div class="form-group">
                                          <div class="col-md-10">
                                              <label class="col-md-4 control-label" >L.G.A</label>
                                          <div class="col-md-8">
                                      ...
                                      <div class="form-group">
                                       ...
                                       <div class="form-group">
                                        ...
                                        <p>  I <input type="checkbox" id="conditionterms" name="conditionterms" value="checkbox" />
                                           <small>Agree with the <a class="toggle-modal"  onclick=" OpenPopupCenter('terms.php','Terms And Codition','600','600')"  ><b>TERMS AND CONDITION</b></a> of Hafsat Store</small>
...
<script language="javascript" type="text/javascript">
    ...
    <script type="text/javascript">
            //$(document).ready(function(){
                //$("#state").on('change',
                function stateOpenLga(){
                    switch($("#state").val()){
                        case 'kano': $('#lga').empty();
                        $("#lga").append("<option value='dala'>Dala</option><option value='gwarzo'>Gwarzo</option><option value='kumbotso'>Kumbotso</option>");
                        break;
                        case 'kebbi': $('#lga').empty();
                        $("#lga").append("<option value='bagudo'>Bagudo</option><option value='bunza'>Bunza</option><option value='dandi'>Dandi</option>");
                        break;
                        case 'katsina': $('#lga').empty();
                        $("#lga").append("<option value='funtua'>Funtua</option><option value='kaita'>Kaita</option><option value='rimi'>Rimi</option>");
                        break;
                        case 'kaduna': $('#lga').empty();
                        $("#lga").append("<option value='giwa'>Giwa</option><option value='zaria'>Zaria</option><option value='kataf'>Kataf</option>");
                    }
                }
            //  );
          //  });
