  ...
  <div class="modal-content">
	<div class="modal-header">
		...
		<table>
			<tr>
				<td align="center">
				<h2><span style="color:#fe980f;">Hafsat</span><span style="color:#B4B1AB;">-Store</span></h2>
        		</td>
			</tr>
		</table>
				 ...
				 $subtot=0;
				  $query = "SELECT *
						...
						echo '<tr>';
				  		...
				  		echo '<td> NGN '. number_format($result->PROPRICE,2).' </td>';
				  		echo '<td align="center" >'. $result->ORDEREDQTY.'</td>';
				  		?>
				  		 <td> NGN <output><?php echo  number_format($result->ORDEREDPRICE,2); ?></output></td>
				  		<?php
		...
		?>
 		...
 		<div class="row">
		  	...
		  	<div class="col-md-6 pull-right">
		  		<p align="right">Total Price : NGN <?php echo number_format($subtot,2);?></p>
		  		<p align="right">Delivery Fee : NGN <?php echo number_format($price,2); ?></p>
		  		<p align="right">Overall Price : NGN <?php echo number_format($cur->PAYMENT,2); ?></p>
		  	</div>
		  </div>
