...
<body style="background-color:white" onload="totalprice()" >
  ...
  <header id="header"><!--header-->
          ...
          <div class="col-sm-6">
            <div class="contactinfo">
              <ul class="nav nav-pills">
                <li><a href="#"><i class="fa fa-phone"></i> +234 7034555057</a></li>
                <li><a href="#"><i class="fa fa-envelope"></i> hafsat@gmail.com</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-md-4 clearfix">
            <div class="logo pull-left">
              <a href="<?php echo web_root?>"><h2><span style="color:#fe980f;">Hafsat</span><span style="color:#B4B1AB;">-Store</span></h2></a>
            </div>
          </div>
    ...
    <div class="footer-widget">
      <div class="container"
        <div class="row">
          ...
          <div class="col-sm-3">
            <div class="single-widget">
              <h2>About Hafsat Store</h2>
              <ul class="nav nav-pills nav-stacked">
                <li><a href="index.php?q=about">Company Information</a></li>
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          <p class="text-center">2019 Copyright © Hafsat Store. All Rights Reserved.</p>
        </div>
      </div>
    </div>
